    ...
    <main className="min-h-screen bg-gray-900 pt-16">
        ...
        <div className="container mx-auto px-4 z-10 relative">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/80">
              Explore our portfolio of completed projects across various sectors and locations.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-900">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-white">Completed Projects</h2>
            ...
            {filteredProjects.map(project => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-400 text-sm mb-3">{project.location} | {project.year}</p>
      ...
      <section className="py-16 px-4 bg-gray-800">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 text-white">Let's Build Something Great Together</h2>
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-gray-700 shadow-xl shadow-blue-500/10">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-400 mb-4">{selectedProject.location} | {selectedProject.year}</p>
